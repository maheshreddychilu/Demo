...
public class ColumnViewObjects {
...
/*	@FindBy(xpath = "//img[@src='http://static-dev.contentstack.io/images/single_line.png']")
	...
	*/
	...
	//Entry
		...
		@FindBy(xpath = "//textarea[@data-ng-model='field.value']")
	...
	//Column view options	
		...
		@FindBy(xpath = "//img[@src='/static/images/column_icon.png']")
		public static WebElement coloumnViewICon;
		
		@FindBy(xpath = "//span[contains(text(),'Single line textbox')]")
		public static WebElement singleLineTextBox;

		@FindBy(xpath = "//span[contains(text(),'Multi line textbox')]")
		public static WebElement multiLineTextBox;
		
		@FindBy(xpath = "//span[contains(text(),'Number')]")
		public static WebElement numberColumnView;
		
		@FindBy(xpath = "//span[contains(text(),'Boolean')]")
		public static WebElement booleanColumnView;

		@FindBy(xpath = "//span[contains(text(),'Date')]")
		public static WebElement dateColumnView;
		
	
		
		
		@FindBy(xpath = "//div[contains(text(),'Single line textbox')]")
		public static WebElement singleHeader;

		@FindBy(xpath = "//span[contains(text(),'builtio')]")
		public static WebElement singleValue;
		
		
		
		@FindBy(xpath = "//div[contains(text(),'Boolean')]")
		public static WebElement booleanHeader;
		
		@FindBy(xpath = "//span[contains(text(),'true')]")
		public static WebElement booleanText;
		...
		@FindBy(xpath = "//span[@data-ng-if='column.dataType == 'isodate'']")
		...
		public static WebElement numberHeader;
		
		@FindBy(xpath = "//span[contains(text(),'25')]")
		public static WebElement numberValue;
		

		
		
		@FindBy(xpath = "//div[contains(text(),'Multi line textbox')]")
		public static WebElement multiLineHeader;
		
		@FindBy(xpath = "//span[contains(text(),'contentstack')]")
		public static WebElement multiLineValue;
}
